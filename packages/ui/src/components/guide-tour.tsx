...
const GuidedTourTooltip = (properties: TooltipRenderProps) => {
  const intl = useIntl();
...
type GuidedTourProperties = Omit<JoyrideProperties, "tooltipComponent">;

export const GuidedTour = (properties: GuidedTourProperties) => (
  <Joyride {...properties} tooltipComponent={GuidedTourTooltip} />
);
