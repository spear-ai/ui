        ...
        <Form.Field className="group" name="sensor" serverInvalid={hasError}>
          ...
          <Form.Control asChild>
            <Select.Root disabled={isDisabled}>
              <Select.Trigger
                // eslint-disable-next-line tailwindcss/no-arbitrary-value
                className="group mt-3 inline-flex h-9 w-full cursor-default items-center justify-between gap-1 rounded-lg bg-white-a-3 pe-2 ps-3.5 text-base leading-none text-neutral-12 outline outline-offset-0 outline-neutral-a-7 data-disabled:pointer-events-none data-disabled:text-neutral-8 data-disabled:outline-neutral-a-6 data-open:outline-neutral-a-8 data-placeholder:text-neutral-9 hover:outline-neutral-a-8 theme-underway:shadow sm:ps-3 sm:text-sm [[data-invalid]_&]:outline-x-negative-a-7 [[data-invalid]_&]:data-disabled:outline-x-negative-a-6 [[data-invalid]_&]:hover:outline-x-negative-a-8"
                id={sensorFormId}
              >
              ...
              <Select.Portal>
                <Select.Content
                  className="isolate max-h-select-content-available-height rounded-xl bg-white-a-3 shadow-lg !outline !outline-1 outline-offset-0 !outline-neutral-a-6 theme-forerunner:backdrop-blur"
                  position="popper"
                  sideOffset={8}
                >
