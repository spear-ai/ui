        ...
        <Form.Field className="group" name="sensor" serverInvalid={hasError}>
          ...
          <Form.Control asChild>
            <Select.Root disabled={isDisabled}>
              <Select.Trigger
                // eslint-disable-next-line tailwindcss/no-arbitrary-value
                className="group mt-3 inline-flex h-9 w-full cursor-default items-center justify-between gap-1 rounded-lg bg-white-a-3 pe-2 ps-3.5 text-base leading-none text-neutral-12 shadow outline outline-offset-0 outline-neutral-a-7 data-disabled:pointer-events-none data-disabled:text-neutral-a-8 data-open:outline-2 data-open:outline-primary-a-8 data-placeholder:text-neutral-11 focus-visible:outline-primary-a-8 theme-galapago:bg-white theme-galapago:text-neutral-light-12 theme-galapago:shadow-none theme-galapago:data-disabled:text-neutral-light-7 theme-galapago:data-placeholder:text-neutral-light-9 theme-forerunner:dark:bg-black-a-3 sm:ps-3 sm:text-sm [[data-invalid]_&]:outline-x-negative-a-7 [[data-invalid]_&]:data-disabled:outline-x-negative-a-6"
                id={sensorFormId}
              >
